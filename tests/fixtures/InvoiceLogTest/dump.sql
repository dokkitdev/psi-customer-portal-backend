...
INSERT INTO users(id, name, email, password, remember_token, set_password_hash, role_id, created_at, updated_at, invoice_permission_level) VALUES
  (1, 'Gerhard Feest', 'fidel.kutch@example.com', '$2y$10$X4receiTrF24bXrEbAiChOZ8TMNPqoXuhuThgynvBdWIHZeu5HzsS', null, null, 1, '2016-10-20 11:05:00', '2016-10-20 11:05:00', 'View'),
  (2, 'Alien West', 'alien.west@example.com', 'old_password', null, 'restore_token', 2, '2016-10-20 11:05:00', '2016-10-20 11:05:00', 'View'),
  (3, 'Third User', 'third.user@example.com', 'old_password', null, null, 2, '2016-10-20 11:05:00', '2016-10-20 11:05:00', 'No Access');
...
INSERT INTO invoice_logs(id, invoice_id, handle_status, handle_result) VALUES
  (1, 103987, 'new', null);
